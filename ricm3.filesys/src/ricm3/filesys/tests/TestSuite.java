...
public class TestSuite {
  ...
  public static void test00(IDirectory root) throws FSException, EOFException, IOException {
    IDirectory dir;
    IDirectory home;
    IDirectory homex;
    IDirectory tmp;
   ...
   */
  private static void test00a(IDirectory root) throws FSException, IOException {
    IDirectory dir, tmp;
   ...
   *    - directory removal
   */
  private static void test00b(IDirectory root) throws FSException, IOException {
    IDirectory dir, tmp;
    // let's create directory /boot/
    dir = root.mkdir("boot");
   ...
   */
  private static void test00c(IDirectory root) throws FSException, IOException {
    IDirectory dir, tmp;
    // let's create directory /boot/
    dir = root.mkdir("boot");
   ...
   * @throws FSException
   */
  static void checkRemoved(IDirectory parent, IDirectory child) throws FSException, IOException {
    ensure(!child.valid());
    try {
