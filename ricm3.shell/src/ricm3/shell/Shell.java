...
public class Shell {
  ...
  private void interpret(String words[]) throws FSException, IOException, ricm3.filesys.EOFException {
    String[] args = null;
    if (words.length > 1) {
   ...
   */
  private IDirectory nameToDir(IDirectory d, String name, boolean create) throws FSException, IOException {
    name = name.trim();
    if (name.length() == 0)
      return d;
    if (name.equals("."))
   ...
   * @throw FSException if the path is not a valid path to a directory.
   */
  private IDirectory pathToDir(String path, boolean create) throws FSException, IOException {
    IDirectory d = wd;
    if (path.startsWith("/")) {
      d = root;
   ...
   */
  private IFile pathToFile(String path, boolean create) throws FSException, IOException {
    IDirectory d = wd;
    if (path.startsWith("/")) {
      d = root;
      path = path.substring(1);
 ...
 * @throws IOException 
   */
  private void cd(String args[]) throws FSException, IOException {
 ...
 * @throws IOException 
   */
  private void mkdir(String args[]) throws FSException, IOException {
    if (args == null || args.length < 1)
      fail("  -- missing path");
 ...
 * @throws IOException 
   */
  private void rmdir(String args[]) throws FSException, IOException {
    IDirectory d;
    if (args == null || args.length < 1)
      fail("  -- missing path");
 ...
 * @throws IOException 
   */
  private void ls(String args[]) throws FSException, IOException {
    IDirectory d = wd;
    if (args != null && args.length > 0) {
      String path = args[0];
 ...
 * @throws IOException 
   */
  private void touch(String args[]) throws FSException, IOException {
    if (args == null || args.length < 1)
      fail("  -- missing path");
    String path = args[0];
 ...
 * @throws IOException 
   */
  private void rm(String args[]) throws FSException, IOException {
    if (args == null || args.length < 1)
      fail("  -- missing path");
    IDirectory d = wd;
    String path = args[0];
   ...
   * @throws FSException
 * @throws IOException 
 * @throws ricm3.filesys.EOFException 
   */
  private void cat(String args[]) throws FSException, IOException, ricm3.filesys.EOFException {
    if (args == null || args.length < 1)
      fail("  -- missing path");
    IDirectory d = wd;
    String path = args[0];
 ...
 * @throws IOException 
   */
  private void edit(String args[]) throws FSException, IOException {
    if (args == null || args.length < 1)
      fail("  -- missing path");
    IDirectory d = wd;
    String path = args[0];
   ...
   */
  private Object parsePath(String path) throws FSException, IOException {
   ...
   */
  private void mv(String args[]) throws FSException, IOException {
